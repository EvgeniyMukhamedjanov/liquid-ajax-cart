...
If you have any script that calls `stopPropagation` method for product forms' `submit` event — switch it off. Otherwise Liquid Ajax Cart will not be able to handle the "Add to Cart" user's action.
