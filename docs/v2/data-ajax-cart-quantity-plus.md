...
An attribute which identifies a "Plus" button inside a [`<ajax-cart-quantity>`](/v2/ajax-cart-quantity/) custom tag.
</p>
...
{% endraw %}
{%- endcapture -%}
{% include v2/codeblock.html title="sections/my-ajax-cart.liquid" language="liquid" code=highlight_code highlight_lines="26" %}
