...
The function that checks browser compatibility is called `isCompatible` and it is located in the [index.ts](https://github.com/EvgeniyMukhamedjanov/liquid-ajax-cart/blob/v1/_src/index.ts) file.